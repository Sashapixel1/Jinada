...
-- Версия 2.3 — фикс GUI (TextXAlignment), без телепорта к CDK altar
...
---------------------
-- ЛОКАЦИИ (только для Tushita/Yama)
---------------------
local Locations = {
...
local ScreenGui, MainFrame, ToggleButton, StatusLabel, UptimeLabel, SpeedLabel, LogsText
